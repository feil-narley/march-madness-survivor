...
export default function EntriesTable({ entries, matchups, scenario }: EntriesTableProps) {
  ...
  const pickCols: { label: string; key: keyof Entry; dayLabel?: string }[] = [
    ...
    { label: 'Pick 3', key: 'pick3', dayLabel: 'Day 2' },
    { label: 'Pick 4', key: 'pick4', dayLabel: 'Day 2' },
    ...
    { label: 'Pick 10', key: 'pick10', dayLabel: 'Day 4' },
    { label: 'Pick 11', key: 'pick11', dayLabel: 'Day 4' },
    { label: 'Pick 12', key: 'pick12', dayLabel: 'Today' },
    { label: 'Pick 13', key: 'pick13', dayLabel: 'Today' },
  ];
